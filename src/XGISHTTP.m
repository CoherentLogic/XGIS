...
SERVER()
 ...
 . N CTYPE S CTYPE=OUT(5.8,RSRCIEN_",","CONTENT TYPE")
 . D NEWRESP(.RESP,CTYPE,200,"OK")
 . N WPLINE S WPLINE=""
 . F I=1:1 S WPLINE=$O(OUT(5.8,RSRCIEN_",","BODY",WPLINE)) Q:WPLINE=""  D
 . . D ADDBODY(.RESP,OUT(5.8,RSRCIEN_",","BODY",WPLINE))
 . D FINALIZE(.RESP)
 . D SEND(.RESP) 
NOGO
...
FINALIZE(OA)
 ...
 D ADDHDR(.OA,$$HDR("Connection","close"))
 Q
